...
var gen_custom_page_1 = require("src/views/custom/gen-custom-page");
...
var Routes = /** @class */ (function (_super) {
    ...
    Routes.prototype.addClientRoutes = function () {
        ...
        this.addPageRoute("/custom", function () { return new abstract_routes_1.PageRouteInfos(gen_custom_page_1.CustomPage); }, abstract_routes_1.PUBLIC_ROUTE);
        /* Routes lazy */

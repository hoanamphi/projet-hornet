...
var form_service_impl_data_1 = require("src/services/data/admin/fvm/form-service-impl-data");
...
var FormulaireDemandeAuthentificationRoutesServer = /** @class */ (function (_super) {
    ...
    function FormulaireDemandeAuthentificationRoutesServer() {
        ...
        _this.addDataRoute("/", function () { return new abstract_routes_1.DataRouteInfos(fvm_action_1.InserDemandeAuthentification, null, form_service_impl_data_1.FormServiceImplData); }, roles_1.Roles.ADMIN, "post");
        // Route effectuant une action d'insertion d'une valise
        // L'action prend un service de type FormService en entrée
        _this.addDataRoute("/insertValise", function () { return new abstract_routes_1.DataRouteInfos(fvm_action_1.InserValise, null, form_service_impl_data_1.FormServiceImplData); }, roles_1.Roles.ADMIN, "post");
        // Route effectuant une action de listage des valises stockées dans la base
        // L'action prend un service de type FormService en entrée
        _this.addDataRoute("/listValises", function () { return new abstract_routes_1.DataRouteInfos(fvm_action_1.ListValise, null, form_service_impl_data_1.FormServiceImplData); }, abstract_routes_1.PUBLIC_ROUTE, "post");
        return _this;
    }

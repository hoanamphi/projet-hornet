...
// Static variables
    ...
    Log4js.Logger.prototype = {
        ...
        debug: function (message, throwable) {
            if (this.isDebugEnabled()) {
                this.log(Log4js.Level.DEBUG, message, throwable || null);
            }
        },
        ...
        info: function (message, throwable) {
            if (this.isInfoEnabled()) {
                this.log(Log4js.Level.INFO, message, throwable || null);
            }
        },
        ...
        warn: function (message, throwable) {
            if (this.isWarnEnabled()) {
                this.log(Log4js.Level.WARN, message, throwable || null);
            }
        },
        ...
        error: function (message, throwable) {
            if (this.isErrorEnabled()) {
                this.log(Log4js.Level.ERROR, message, throwable || null);
            }
        },
        ...
        fatal: function (message, throwable) {
            if (this.isFatalEnabled()) {
                this.log(Log4js.Level.FATAL, message, throwable || null);
            }
        },
        /**
    ...
    /**
     * ThinLayout consists of the level of the log statement, followed by " | "
     * and then the log message itself. For example,
     * <code>DEBUG - Hello world</code>
     *
     * @constructor
     ...
     * @author Stephan Strittmatter
     */
    Log4js.ThinLayout = function () {
        this.LINE_SEP = "\n";
        this.LINE_SEP_LEN = 1;
    };

    Log4js.ThinLayout.prototype = Log4js.extend(new Log4js.Layout(), {
        /**
         * Implement this method to create your own layout format.
         * @param {Log4js.LoggingEvent} loggingEvent loggingEvent to format
         * @return formatted String
         ...
         */
        format: function (loggingEvent) {
            var categoryNameSplit = loggingEvent.categoryName.split(".");
            var categoryName;
            if(categoryNameSplit.length > 1){
                categoryName = categoryNameSplit[categoryNameSplit.length-1];
            }
            return loggingEvent.level.toString() + "|" + categoryName + "|" + loggingEvent.message + this.LINE_SEP;
        },
        /**
         * Returns the content type output by this layout.
         * @return The base class returns "text/plain".
    ...
    Log4js.BasicLayout.prototype = Log4js.extend(new Log4js.Layout(), {
         ...
         */
        format: function (loggingEvent) {
            return loggingEvent.startTime.toLocaleString() + "|" + loggingEvent.level.toString() + "|" + loggingEvent.categoryName + "|" + loggingEvent.message + this.LINE_SEP;
        },
        /**
         * Returns the content type output by this layout.
         * @return The base class returns "text/plain".
    ...
    Log4js.JSONLayout.prototype = Log4js.extend(new Log4js.Layout(), {
        ...
        format: function (loggingEvent) {
            ...
            jsonString += "\t\"message\": \"" + loggingEvent.message.replace(/[\n\r]/g, '') + "\",\n";

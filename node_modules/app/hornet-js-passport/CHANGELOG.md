...
-	213322	-	correctif strategy-saml et timeout node sur requete ajax
-	213191	-	Maj regex tsconfig
-	212731	-	maj doc CAS deprecated
-	211254	-	SAML: correctif generation fichier metadata-saml
-	211756	-	correctif gestion profils getUserInfos
-	211767	-	SAML: correctif httpsCert non obligatoire lorsque le idp-metadata.xml est en local
-	211409	-	Update tsconfig.json: ajout conf src
-	211570	-	mep config source typescript
-	212100	-	Update tsconfig.json: typescript src


# hornet-js-passport 5.1.0-rc2
...
- 0056021: [hornet] hornet-js-passport : refactoring.

...
var fs = require("fs");
var app_i18n_loader_1 = require("./i18n/app-i18n-loader");
var HornetServer = require("hornet-js-core/src/server");
var hornet_app_1 = require("./views/layouts/hornet-app");
var hornet_layout_1 = require("./views/layouts/hornet-layout");
...
function initContext() {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("./injector-context-services-data"); })];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, Promise.resolve().then(function () { return require("./injector-context-services-page"); })];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, Promise.resolve().then(function () { return require("./middleware/authentication-api"); })];

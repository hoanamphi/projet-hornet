...
var model_permis_1 = require("src/models/model-permis");
var model_personne_1 = require("src/models/model-personne");
var model_dossier_1 = require("src/models/model-dossier");
...
var ModelDAO = /** @class */ (function (_super) {
    ...
    tslib_1.__decorate([
        dec_seq_entity_1.Entity("personne", model_personne_1.PersonneModel),
        tslib_1.__metadata("design:type", Object)
    ], ModelDAO.prototype, "personneEntity", void 0);
    tslib_1.__decorate([
        dec_seq_entity_1.Entity("dossier", model_dossier_1.DossierModel),
        tslib_1.__metadata("design:type", Object)
    ], ModelDAO.prototype, "dossierEntity", void 0);
    tslib_1.__decorate([
